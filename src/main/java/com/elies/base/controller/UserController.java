...
import com.elies.base.common.RedisService;
import com.elies.base.common.ResponseUtil;
import com.elies.base.constant.ResponseMessage;
import com.elies.base.domain.*;
...
public class UserController {
    ...
    public ResponseUtil userLogin(
        ...
        try{
            redisService.set("test1", "test1", 1800L, TimeUnit.HOURS);
        for(int i=0; i<100000; i++){

        }
        String str = redisService.get("test1");
